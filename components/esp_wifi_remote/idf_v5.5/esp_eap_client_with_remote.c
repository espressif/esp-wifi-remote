...
{
    return esp_eap_client_remote_clear_identity();
}
...
{
    return esp_eap_client_remote_clear_username();
}
...
{
    return esp_eap_client_remote_clear_password();
}
...
{
    return esp_eap_client_remote_clear_new_password();
}
...
{
    return esp_eap_client_remote_clear_ca_cert();
}
...
{
    return esp_eap_client_remote_clear_certificate_and_key();
}
...
{
    return esp_wifi_set_okc_support(enable);
}
